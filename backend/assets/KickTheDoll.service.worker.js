...
/** @type {string} */
const CACHE_VERSION = '1727158520|89744336';
/** @type {string} */
const CACHE_PREFIX = 'KickTheDoll-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'KickTheDoll.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["KickTheDoll.html", "KickTheDoll.js", "KickTheDoll.offline.html", "KickTheDoll.icon.png", "KickTheDoll.apple-touch-icon.png", "KickTheDoll.worker.js", "KickTheDoll.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["KickTheDoll.wasm", "KickTheDoll.pck", "KickTheDoll.side.wasm", "godot_rapier.wasm"];
